...
var generaSpider = function (beforData) {
   return new Promise(resolve=> {
...
var worm = function (key, index, text, level, isType) {
	...
	}).then(classSpider(data)).then(generaSpider(beforData)).then(seedSpider(data))
}
